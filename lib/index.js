...
console.log(chalk.whiteBright("Modified Baileys WhatsApp API by FarizGD"));
console.log(
  chalk.whiteBright(" Version: ") + chalk.greenBright("v2.67.69")
);
...
// ============================
// better __createBinding (than pongbaileys wtf is that name)
// ============================
